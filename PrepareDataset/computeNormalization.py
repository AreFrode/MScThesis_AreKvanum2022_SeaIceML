...
def main():
    path_prepareddata = f"/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/PrepareDataset/Data/amsr2_input/lead_time_{sys.argv[1]}/"
    ...
    compute_and_save_normalization(np.concatenate([data[f'{i}'] for i in range(2019, 2021)]), fields, path_prepareddata, "normalization_constants_train.csv")
