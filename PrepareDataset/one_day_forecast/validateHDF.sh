...
def main():
    path = "/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/PrepareDataset/Data/one_day_forecast/"
    path_figures = "/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/PrepareDataset/figures/one_day_forecast/"
    ...
    for date in data[$SGE_TASK_ID - 1]:
        ...
        ax.set_title(f"Target for one day forecast initiated {date[-13:-5]}", fontsize=30)
