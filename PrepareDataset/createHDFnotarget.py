...
def main():
    ...
    # NN land mask path
    # else:
    path_outputs = [f"/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/PrepareDataset/Data/noTarget/lead_time_{i}/" for i in lead_times]
    ...
    for dd in range(1, nb_days_task + 1):
        ...
        # Prepare output hdf5 file
            hdf5_path = f"{path_outputs[i]}{year_task}/{month_task}/PreparedSample_b{yyyymmdd}.hdf5"
        ...
        # if mode == "reduced_classes":
            ...
            with h5py.File(hdf5_path, 'w') as outfile:
                ...
                for j, trend in enumerate(osisaf_trends):
                    outfile[f'osisaf_trend_{trend}/sic_trend'] = conc_trend[j]
