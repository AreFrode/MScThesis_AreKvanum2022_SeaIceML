...
cat > "/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/AROME_ARCTIC_regrid/data_processing_files/PROG/regrid_arome_1km_two_day_forecast""$SGE_TASK_ID"".py" << EOF
...
def main():
    ...
    path_output = '/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/AROME_ARCTIC_regrid/Data/two_day_forecast/'
