...
def main():
    ...
    path_output = f'/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/AROME_ARCTIC_regrid/Data/{target_resolution}km/'

    proj4_arome = "+proj=lcc +lat_0=77.5 +lon_0=-25 +lat_1=77.5 +lat_2=77.5 +no_defs +R=6.371e+06"

    nick_path = "/lustre/storeB/users/nicholsh/"
    icechart_path = f"{nick_path}icecharts_2022.nc"
    ...
    with Dataset(icechart_path, 'r') as icecharts:
    ...
    for dd in range(1, nb_days_task + 1):
        ...
        # Output netcdf file
        ################################################
        output_filename = f"AROME_{target_resolution}kmgrid_{yyyymmdd}T18Z.nc"
