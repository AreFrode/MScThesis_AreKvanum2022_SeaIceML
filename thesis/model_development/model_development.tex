...
\todo{Write about sample construction, normalization of input data, mention how it is done, and what precuations have been taken. Especially SIC is categorical, but treated as numerical (kind of). Temporal concenrns of the data with respect to operational extensions should be mentioned here}
