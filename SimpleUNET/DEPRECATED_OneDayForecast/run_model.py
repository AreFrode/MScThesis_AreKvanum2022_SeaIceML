...
def main():
    ...
    SEED_VALUE = 0
    PATH_OUTPUT = "/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/SimpleUNET/OneDayForecast/outputs/"
    ...
    log_dir = f"/lustre/storeB/users/arefk/MScThesis_AreKvanum2022_SeaIceML/SimpleUNET/OneDayForecast/logs/fit/{datetime.now().strftime('%d%m%H%M')}"
